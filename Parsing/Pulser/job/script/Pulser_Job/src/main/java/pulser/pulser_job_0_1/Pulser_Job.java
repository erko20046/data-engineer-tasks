...
/**
 * Job: Pulser_Job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Pulser_Job implements TalendJob {
...
public String getUser_out(){
	...
	private final String jobName = "Pulser_Job";
	private final String projectName = "PULSER";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Pulser_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row19Struct implements routines.system.IPersistableRow<row19Struct> {
    final static byte[] commonByteArrayLock_PULSER_Pulser_Job = new byte[0];
    static byte[] commonByteArray_PULSER_Pulser_Job = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PULSER_Pulser_Job) {
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n	CASE\n           WHEN (select parsed FROM "+context.schema_mon+".parser_monitoring where name = 'pulser')\n               THEN true\n           ELSE false\n    END b;";
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("pulser_categories");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("pulser_categories");
}
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"is_active\" = ? WHERE \"category_id\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_6";
		...
		int tos_count_tDBInput_6 = 0;
		    ...
		    String dbquery_tDBInput_6 = "select\n	category_id, false as is_active\nfrom "+context.schema_out+".pulser_categories";
            ...
            row5.category_id = rs_tDBInput_6.getInt(1);
...
update_categories_tmp.category_id = row5.category_id ;
...
pstmt_tDBOutput_3.setNull(1, java.sql.Types.BOOLEAN);
                    ...
                    if(update_categories.category_id == null) {
pstmt_tDBOutput_3.setNull(2 + count_tDBOutput_3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(2 + count_tDBOutput_3, update_categories.category_id);
}
...
public static class insert_categories_1Struct implements routines.system.IPersistableRow<insert_categories_1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PULSER_Pulser_Job.length) {
				if(length < 1024 && commonByteArray_PULSER_Pulser_Job.length == 0) {
   					commonByteArray_PULSER_Pulser_Job = new byte[1024];
				} else {
   					commonByteArray_PULSER_Pulser_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PULSER_Pulser_Job, 0, length);
			strReturn = new String(commonByteArray_PULSER_Pulser_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PULSER_Pulser_Job, 0, length);
			strReturn = new String(commonByteArray_PULSER_Pulser_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("pulser_categories");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("pulser_categories");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"name\",\"level\",\"is_active\") VALUES (?,?,?)";
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("pulser_categories");
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("pulser_categories");
}
...
int count_tDBOutput_5=0;
	    String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5 + "\" SET \"is_active\" = ?,\"relevance\" = ? WHERE \"name\" = ? AND \"level\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            row1.is_active = rs_tDBInput_2.getBoolean(3);
            if(rs_tDBInput_2.wasNull()){
                    row1.is_active = null;
            }
		                    }
			...
			row1.relevance = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 4);
		                    }
...
} else {pstmt_tDBOutput_1.setBoolean(3, insert_categories_1.is_active);
}
...
} else {pstmt_tDBOutput_5.setInt(4 + count_tDBOutput_5, updateCategories_1.level);
}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("pulser_categories");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("pulser_categories");
}
...
copyOfsubjects_tmp.prod_id = row4.category_id ;
...
if(dbschema_tDBOutput_22 == null || dbschema_tDBOutput_22.trim().length() == 0) {
	tableName_tDBOutput_22 = ("pulser_categories");
} else {
	tableName_tDBOutput_22 = dbschema_tDBOutput_22 + "\".\"" + ("pulser_categories");
}
...
int count_tDBOutput_22=0;
	    String insert_tDBOutput_22 = "INSERT INTO \"" + tableName_tDBOutput_22 + "\" (\"name\",\"parent_id\",\"level\",\"is_active\") VALUES (?,?,?,?)";
...
if(dbschema_tDBOutput_23 == null || dbschema_tDBOutput_23.trim().length() == 0) {
	tableName_tDBOutput_23 = ("pulser_categories");
} else {
	tableName_tDBOutput_23 = dbschema_tDBOutput_23 + "\".\"" + ("pulser_categories");
}

        int updateKeyCount_tDBOutput_23 = 2;
        if(updateKeyCount_tDBOutput_23 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_23 == 5 && true) {        
                throw new RuntimeException("For update, every Schema column can not be a key");
        }
...
int count_tDBOutput_23=0;
	    String update_tDBOutput_23 = "UPDATE \"" + tableName_tDBOutput_23 + "\" SET \"level\" = ?,\"is_active\" = ?,\"relevance\" = ? WHERE \"name\" = ? AND \"parent_id\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_34";
		...
		int tos_count_tDBInput_34 = 0;
            ...
            row33.is_active = rs_tDBInput_34.getBoolean(5);
            if(rs_tDBInput_34.wasNull()){
                    row33.is_active = null;
            }
		                    }
			...
			row33.relevance = routines.system.JDBCUtil.getDate(rs_tDBInput_34, 6);
		                    }
...
pstmt_tDBOutput_23.setNull(3, java.sql.Types.TIMESTAMP);
                    ...
                    if(update.name == null) {
pstmt_tDBOutput_23.setNull(4 + count_tDBOutput_23, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_23.setString(4 + count_tDBOutput_23, update.name);
}


                    if(update.parent_id == null) {
pstmt_tDBOutput_23.setNull(5 + count_tDBOutput_23, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_23.setInt(5 + count_tDBOutput_23, update.parent_id);
}
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("pulser_categories");
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("pulser_categories");
}
 ...
 */
	...
	currentComponent="tDBInput_12";
		...
		int tos_count_tDBInput_12 = 0;
		    ...
		    String dbquery_tDBInput_12 = "select category_id,\n	name, parent_id\nfrom "+context.schema_in+".pulser_categories\n	where priority = 2 and name is not NULL;";
...
upd_tmp.prod_id = row6.category_id ;
...
public static class update_productsStruct implements routines.system.IPersistableRow<update_productsStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.source_id == null) ? 0 : this.source_id.hashCode());
					
						result = prime * result + ((this.product_url == null) ? 0 : this.product_url.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final update_productsStruct other = (update_productsStruct) obj;
						...
						} else if (!this.product_url.equals(other.product_url))
    ...
    public int compareTo(update_productsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.source_id, other.source_id);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.product_url, other.product_url);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_13 == null || dbschema_tDBOutput_13.trim().length() == 0) {
	tableName_tDBOutput_13 = ("pulser_products");
} else {
	tableName_tDBOutput_13 = dbschema_tDBOutput_13 + "\".\"" + ("pulser_products");
}
...
int count_tDBOutput_13=0;
	    String insert_tDBOutput_13 = "INSERT INTO \"" + tableName_tDBOutput_13 + "\" (\"name\",\"source_id\",\"price\",\"product_url\",\"category_id\") VALUES (?,?,?,?,?)";
...
if(dbschema_tDBOutput_15 == null || dbschema_tDBOutput_15.trim().length() == 0) {
	tableName_tDBOutput_15 = ("pulser_products");
} else {
	tableName_tDBOutput_15 = dbschema_tDBOutput_15 + "\".\"" + ("pulser_products");
}

        int updateKeyCount_tDBOutput_15 = 2;
        if(updateKeyCount_tDBOutput_15 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_15 == 6 && true) {        
                throw new RuntimeException("For update, every Schema column can not be a key");
        }
...
int count_tDBOutput_15=0;
	    String update_tDBOutput_15 = "UPDATE \"" + tableName_tDBOutput_15 + "\" SET \"name\" = ?,\"price\" = ?,\"category_id\" = ?,\"relevance\" = ? WHERE \"source_id\" = ? AND \"product_url\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_22";
		...
		int tos_count_tDBInput_22 = 0;
		    ...
		    String dbquery_tDBInput_22 = "select\n	title, \n	source_id,\n	price,\n	product_url,\n	category_id,\n	now() as relevance\nfrom "+context.schema_in+".pulser_products\nWHERE source_id IS NOT null;";
        	...
        	row22.title = routines.system.JDBCUtil.getString(rs_tDBInput_22, 1, false);
		                    }
							if(colQtyInRs_tDBInput_22 < 2) {
								row22.source_id = null;
							} else {
		                          
            row22.source_id = rs_tDBInput_22.getLong(2);
            ...
            row22.price = rs_tDBInput_22.getInt(3);
            if(rs_tDBInput_22.wasNull()){
                    row22.price = null;
            }
		                    }
            ...
            row22.category_id = rs_tDBInput_22.getInt(5);
            if(rs_tDBInput_22.wasNull()){
                    row22.category_id = null;
            }
		                    }
			...
			row22.relevance = routines.system.JDBCUtil.getDate(rs_tDBInput_22, 6);
		                    }
...
products_tmp.name = row22.title ;
products_tmp.source_id = row22.source_id ;
products_tmp.price = row22.price ;
 					    ...
 					    boolean forceLooprow23 = false;
 							...
 							row23Struct row23ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_13 = false;
                        		    		    ...
                        		    		    row23HashKey.source_id = products.source_id ;
                        		    		
                        		    		    row23HashKey.product_url = products.product_url;
								  ...
								  if(!tHash_Lookup_row23.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row23 != null && tHash_Lookup_row23.getCount(row23HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row23' and it contains more one result from keys :  row23.source_id = '" + row23HashKey.source_id + "', row23.product_url = '" + row23HashKey.product_url + "'");
								} // G 071
...
update_products_tmp.name = products.name ;
update_products_tmp.source_id = products.source_id ;
update_products_tmp.price = products.price ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_13 ) {
insert_products_tmp.name = products.name ;
insert_products_tmp.source_id = products.source_id ;
insert_products_tmp.price = products.price ;
...
} else {pstmt_tDBOutput_13.setString(1, insert_products.name);
}

                    if(insert_products.source_id == null) {
pstmt_tDBOutput_13.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_13.setLong(2, insert_products.source_id);
}

                    if(insert_products.price == null) {
pstmt_tDBOutput_13.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_13.setInt(3, insert_products.price);
}
...
} else {pstmt_tDBOutput_13.setInt(5, insert_products.category_id);
}
...
pstmt_tDBOutput_15.setNull(1, java.sql.Types.VARCHAR);
                    ...
                    if(update_products.price == null) {
pstmt_tDBOutput_15.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_15.setInt(2, update_products.price);
}
...
pstmt_tDBOutput_15.setTimestamp(4, new java.sql.Timestamp(update_products.relevance.getTime()));
} else {
pstmt_tDBOutput_15.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(update_products.source_id == null) {
pstmt_tDBOutput_15.setNull(5 + count_tDBOutput_15, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_15.setLong(5 + count_tDBOutput_15, update_products.source_id);
}


                    if(update_products.product_url == null) {
pstmt_tDBOutput_15.setNull(6 + count_tDBOutput_15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_15.setString(6 + count_tDBOutput_15, update_products.product_url);
}
...
if(dbschema_tDBOutput_17 == null || dbschema_tDBOutput_17.trim().length() == 0) {
	tableName_tDBOutput_17 = ("pulser_product_characteristics");
} else {
	tableName_tDBOutput_17 = dbschema_tDBOutput_17 + "\".\"" + ("pulser_product_characteristics");
}
...
if(dbschema_tDBOutput_18 == null || dbschema_tDBOutput_18.trim().length() == 0) {
	tableName_tDBOutput_18 = ("pulser_product_characteristics");
} else {
	tableName_tDBOutput_18 = dbschema_tDBOutput_18 + "\".\"" + ("pulser_product_characteristics");
}
		    ...
		    while (rs_tDBInput_27.next()) {
		        nb_line_tDBInput_27++;
							...
							if(colQtyInRs_tDBInput_27 < 1) {
								row27.source_id = null;
							} else {
		                          
            row27.source_id = rs_tDBInput_27.getLong(1);
 					    ...
 					    boolean forceLooprow42 = false;
 							...
 							row42Struct row42ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_16 = false;
                        		    		    ...
                        		    		    row42HashKey.source_id = row27.source_id ;
								  ...
								  if(!tHash_Lookup_row42.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row42 != null && tHash_Lookup_row42.getCount(row42HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row42' and it contains more one result from keys :  row42.source_id = '" + row42HashKey.source_id + "'");
								} // G 071
...
if(dbschema_tDBOutput_19 == null || dbschema_tDBOutput_19.trim().length() == 0) {
	tableName_tDBOutput_19 = ("pulser_images");
} else {
	tableName_tDBOutput_19 = dbschema_tDBOutput_19 + "\".\"" + ("pulser_images");
}
...
if(dbschema_tDBOutput_20 == null || dbschema_tDBOutput_20.trim().length() == 0) {
	tableName_tDBOutput_20 = ("pulser_images");
} else {
	tableName_tDBOutput_20 = dbschema_tDBOutput_20 + "\".\"" + ("pulser_images");
}
		    ...
		    while (rs_tDBInput_30.next()) {
		        nb_line_tDBInput_30++;
							...
							if(colQtyInRs_tDBInput_30 < 1) {
								row30.source_id = null;
							} else {
		                          
            row30.source_id = rs_tDBInput_30.getLong(1);
 					    ...
 					    boolean forceLooprow31 = false;
 							...
 							row31Struct row31ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_18 = false;
                        		    		    ...
                        		    		    row31HashKey.source_id = row30.source_id ;
								  ...
								  if(!tHash_Lookup_row31.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row31 != null && tHash_Lookup_row31.getCount(row31HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row31' and it contains more one result from keys :  row31.source_id = '" + row31HashKey.source_id + "'");
								} // G 071
 ...
 */
	...
	currentComponent="tDBInput_33";
		...
		int tos_count_tDBInput_33 = 0;
		    ...
		    String dbquery_tDBInput_33 = "select 'pulser' as name, false as parsed, now() as last_migrated";
...
query_tDBRow_1 = "\nTRUNCATE TABLE  "+context.schema_in+".pulser_products CASCADE;\nTRUNCATE TABLE  "+context.schema_in+".pulser_pictures CASCADE;\nTRUNCATE TABLE  "+context.schema_in+".pulser_characteristics CASCADE;\nTRUNCATE TABLE  "+context.schema_in+".pulser_categories CASCADE;\n";
		...
		int tos_count_tDBInput_5 = 0;
        	...
        	row4.name = routines.system.JDBCUtil.getString(rs_tDBInput_5, 1, false);
							...
							if(colQtyInRs_tDBInput_5 < 2) {
								row4.category_id = null;
							} else {
		                          
            row4.category_id = rs_tDBInput_5.getInt(2);
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.category_id = row4.category_id;
 ...
 */
	...
	currentComponent="tDBInput_29";
		...
		int tos_count_tDBInput_29 = 0;
		    ...
		    String dbquery_tDBInput_29 = "select\n	product_id,\n	characteristic_id\nfrom "+context.schema_out+".pulser_product_characteristics;";
 ...
 */
	...
	currentComponent="tDBInput_43";
		...
		int tos_count_tDBInput_43 = 0;
		    ...
		    String dbquery_tDBInput_43 = "select\n	id, source_id \nfrom "+context.schema_out+".pulser_products;";
            ...
            if(rs_tDBInput_43.wasNull()){
                    row42.id = null;
							...
							if(colQtyInRs_tDBInput_43 < 2) {
								row42.source_id = null;
							} else {
		                          
            row42.source_id = rs_tDBInput_43.getLong(2);
            if(rs_tDBInput_43.wasNull()){
                    row42.source_id = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row42";
				...
				row42_HashRow.source_id = row42.source_id;
 ...
 */
	...
	currentComponent="tDBInput_11";
		...
		int tos_count_tDBInput_11 = 0;
		    ...
		    String dbquery_tDBInput_11 = "select\n	name, category_id,parent_id, now() as relevance\nfrom "+context.schema_out+".pulser_categories\n	where level = 2;";
            ...
            row6.category_id = rs_tDBInput_11.getInt(2);
            ...
            if(rs_tDBInput_31.wasNull()){
                    row31.id = null;
							...
							if(colQtyInRs_tDBInput_31 < 2) {
								row31.source_id = null;
							} else {
		                          
            row31.source_id = rs_tDBInput_31.getLong(2);
            if(rs_tDBInput_31.wasNull()){
                    row31.source_id = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row31";
				...
				row31_HashRow.source_id = row31.source_id;
 ...
 */
	...
	currentComponent="tDBInput_32";
		...
		int tos_count_tDBInput_32 = 0;
		    ...
		    String dbquery_tDBInput_32 = "select\n	product_id,\n	file_path,\n	image_url\nfrom "+context.schema_out+".pulser_images;";
 ...
 */
	...
	currentComponent="tDBInput_23";
		...
		int tos_count_tDBInput_23 = 0;
        	...
        	row23.name = routines.system.JDBCUtil.getString(rs_tDBInput_23, 1, false);
		                    }
							if(colQtyInRs_tDBInput_23 < 2) {
								row23.source_id = null;
							} else {
		                          
            row23.source_id = rs_tDBInput_23.getLong(2);
            ...
            row23.price = rs_tDBInput_23.getInt(3);
            if(rs_tDBInput_23.wasNull()){
                    row23.price = null;
            }
		                    }
        	...
        	row23.product_url = routines.system.JDBCUtil.getString(rs_tDBInput_23, 4, false);
		                    }
							if(colQtyInRs_tDBInput_23 < 5) {
								row23.category_id = null;
							} else {
		                          
            row23.category_id = rs_tDBInput_23.getInt(5);
            if(rs_tDBInput_23.wasNull()){
                    row23.category_id = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row23";
				...
				row23_HashRow.source_id = row23.source_id;
				
				row23_HashRow.price = row23.price;
 ...
 */
    ...
    public static void main(String[] args){
        final Pulser_Job Pulser_JobClass = new Pulser_Job();

        int exitCode = Pulser_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Pulser_Job.class.getClassLoader().getResourceAsStream("pulser/pulser_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Pulser_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Pulser_Job");
        }
...
/************************************************************************************************
 *     917868 characters generated by Talend Open Studio for Data Integration 
 *     on the 11 июля 2025 г., 10:48:34 QYZT
 ************************************************************************************************/