...
package bestpack.bestpack_job_0_1;
...
/**
 * Job: bestpack_job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class bestpack_job implements TalendJob {
...
public String getUser_out(){
	...
	private final String jobName = "bestpack_job";
	private final String projectName = "BESTPACK";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(bestpack_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row19Struct implements routines.system.IPersistableRow<row19Struct> {
    final static byte[] commonByteArrayLock_BESTPACK_bestpack_job = new byte[0];
    static byte[] commonByteArray_BESTPACK_bestpack_job = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BESTPACK_bestpack_job) {
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n	CASE\n           WHEN (select parsed FROM "+context.schema_mon+".parser_monitoring where name = 'bestpack')\n               THEN true\n           ELSE false\n    END b;";
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("bestpack_categories");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("bestpack_categories");
}
...
public static class insert_categories_1Struct implements routines.system.IPersistableRow<insert_categories_1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BESTPACK_bestpack_job.length) {
				if(length < 1024 && commonByteArray_BESTPACK_bestpack_job.length == 0) {
   					commonByteArray_BESTPACK_bestpack_job = new byte[1024];
				} else {
   					commonByteArray_BESTPACK_bestpack_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BESTPACK_bestpack_job, 0, length);
			strReturn = new String(commonByteArray_BESTPACK_bestpack_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_BESTPACK_bestpack_job, 0, length);
			strReturn = new String(commonByteArray_BESTPACK_bestpack_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("bestpack_categories");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("bestpack_categories");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"name\",\"is_active\") VALUES (?,?)";
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("bestpack_categories");
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("bestpack_categories");
}
...
int count_tDBOutput_5=0;
	    String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5 + "\" SET \"is_active\" = ?,\"relevance\" = ? WHERE \"name\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            row1.is_active = rs_tDBInput_2.getBoolean(2);
			...
			row1.relevance = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 3);
		                    }
...
} else {pstmt_tDBOutput_1.setBoolean(2, insert_categories_1.is_active);
}
...
pstmt_tDBOutput_5.setNull(1, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_5.setBoolean(1, updateCategories_1.is_active);
}

                    if(updateCategories_1.relevance != null) {
pstmt_tDBOutput_5.setTimestamp(2, new java.sql.Timestamp(updateCategories_1.relevance.getTime()));
} else {
...
} else {pstmt_tDBOutput_5.setString(3 + count_tDBOutput_5, updateCategories_1.name);
}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("bestpack_categories");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("bestpack_categories");
}
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"prod_id\" = ? WHERE \"name\" = ?";
...
public static class insert_productsStruct implements routines.system.IPersistableRow<insert_productsStruct> {
    ...
    static byte[] commonByteArray_BESTPACK_bestpack_job = new byte[0];
			    ...
			    public Float overall_pack_price;

				public Float getOverall_pack_price () {
					return this.overall_pack_price;
				}
				
			    public Float overall_box_price;

				public Float getOverall_box_price () {
					return this.overall_box_price;
				}
			    ...
			    public Float per_discount_price;

				public Float getPer_discount_price () {
					return this.per_discount_price;
				}
			    ...
			    public String product_url_hash;

				public String getProduct_url_hash () {
					return this.product_url_hash;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.title = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.overall_pack_price = null;
           				} else {
           			    	this.overall_pack_price = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.overall_box_price = null;
           				} else {
           			    	this.overall_box_price = dis.readFloat();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.per_discount_price = null;
           				} else {
           			    	this.per_discount_price = dis.readFloat();
           				}
					
					this.product_url = readString(dis);
					
					this.product_url_hash = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Float
						...
						if(this.overall_pack_price == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.overall_pack_price);
		            	}
					
					// Float
				
						if(this.overall_box_price == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.overall_box_price);
		            	}
					...
					// Float
						...
						if(this.per_discount_price == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.per_discount_price);
		            	}
					...
					// String
						...
						writeString(this.product_url_hash,dos);
    ...
    public String toString() {
		...
		sb.append(",overall_pack_price="+String.valueOf(overall_pack_price));
		sb.append(",overall_box_price="+String.valueOf(overall_box_price));
		sb.append(",per_price="+String.valueOf(per_price));
		sb.append(",per_discount_price="+String.valueOf(per_discount_price));
		sb.append(",product_url="+product_url);
		sb.append(",product_url_hash="+product_url_hash);
	    sb.append("]");
...
public static class update_productsStruct implements routines.system.IPersistableRow<update_productsStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.product_url_hash == null) ? 0 : this.product_url_hash.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final update_productsStruct other = (update_productsStruct) obj;
						...
						if (this.product_url_hash == null) {
							if (other.product_url_hash != null)
								return false;
						
						} else if (!this.product_url_hash.equals(other.product_url_hash))
	...
	public void copyDataTo(update_productsStruct other) {
		...
		other.source_code = this.source_code;
	            ...
	            other.overall_pack_price = this.overall_pack_price;
	            other.overall_box_price = this.overall_box_price;
	            other.per_price = this.per_price;
	            other.per_discount_price = this.per_discount_price;
	            other.product_url = this.product_url;
	            other.product_url_hash = this.product_url_hash;
	            other.relevance = this.relevance;
    ...
    public int compareTo(update_productsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.product_url_hash, other.product_url_hash);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_13 == null || dbschema_tDBOutput_13.trim().length() == 0) {
	tableName_tDBOutput_13 = ("bestpack_products");
} else {
	tableName_tDBOutput_13 = dbschema_tDBOutput_13 + "\".\"" + ("bestpack_products");
}
...
int count_tDBOutput_13=0;
	    String insert_tDBOutput_13 = "INSERT INTO \"" + tableName_tDBOutput_13 + "\" (\"source_code\",\"title\",\"category_id\",\"overall_pack_price\",\"overall_box_price\",\"per_price\",\"per_discount_price\",\"product_url\",\"product_url_hash\") VALUES (?,?,?,?,?,?,?,?,?)";
...
if(dbschema_tDBOutput_15 == null || dbschema_tDBOutput_15.trim().length() == 0) {
	tableName_tDBOutput_15 = ("bestpack_products");
} else {
	tableName_tDBOutput_15 = dbschema_tDBOutput_15 + "\".\"" + ("bestpack_products");
}
...
int count_tDBOutput_15=0;
	    String update_tDBOutput_15 = "UPDATE \"" + tableName_tDBOutput_15 + "\" SET \"source_code\" = ?,\"title\" = ?,\"category_id\" = ?,\"overall_pack_price\" = ?,\"overall_box_price\" = ?,\"per_price\" = ?,\"per_discount_price\" = ?,\"product_url\" = ?,\"relevance\" = ? WHERE \"product_url_hash\" = ?";
...
+"e,\n	product_url,\n	product_url_hash,\n	now() as relevance\nfrom "+context.schema_in+".bestpack_products;";
            ...
            if(rs_tDBInput_22.wasNull()){
                    row22.category_id = null;
							...
							if(colQtyInRs_tDBInput_22 < 4) {
								row22.overall_pack_price = null;
							} else {
		                          
            row22.overall_pack_price = rs_tDBInput_22.getFloat(4);
            if(rs_tDBInput_22.wasNull()){
                    row22.overall_pack_price = null;
            }
		                    }
							if(colQtyInRs_tDBInput_22 < 5) {
								row22.overall_box_price = null;
							} else {
		                          
            row22.overall_box_price = rs_tDBInput_22.getFloat(5);
            if(rs_tDBInput_22.wasNull()){
                    row22.overall_box_price = null;
            }
		                    }
            ...
            row22.per_price = rs_tDBInput_22.getFloat(6);
            if(rs_tDBInput_22.wasNull()){
                    row22.per_price = null;
            }
		                    }
							if(colQtyInRs_tDBInput_22 < 7) {
								row22.per_discount_price = null;
							} else {
		                          
            row22.per_discount_price = rs_tDBInput_22.getFloat(7);
            if(rs_tDBInput_22.wasNull()){
                    row22.per_discount_price = null;
            }
		                    }
        	...
        	row22.product_url = routines.system.JDBCUtil.getString(rs_tDBInput_22, 8, false);
		                    }
							if(colQtyInRs_tDBInput_22 < 9) {
								row22.product_url_hash = null;
							} else {
	                         		
        	row22.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_22, 9, false);
		                    }
...
products_tmp.overall_pack_price = row22.overall_pack_price ;
products_tmp.overall_box_price = row22.overall_box_price ;
products_tmp.per_price = row22.per_price ;
products_tmp.per_discount_price = row22.per_discount_price ;
products_tmp.product_url = row22.product_url ;
products_tmp.product_url_hash = row22.product_url_hash ;
 					    ...
 					    boolean forceLooprow23 = false;
 							...
 							row23Struct row23ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_13 = false;
                        		    		    ...
                        		    		    row23HashKey.product_url_hash = products.product_url_hash ;
								  ...
								  if(!tHash_Lookup_row23.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row23 != null && tHash_Lookup_row23.getCount(row23HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row23' and it contains more one result from keys :  row23.product_url_hash = '" + row23HashKey.product_url_hash + "'");
								} // G 071
...
update_products_tmp.title = products.title ;
update_products_tmp.category_id = products.category_id ;
update_products_tmp.overall_pack_price = products.overall_pack_price ;
update_products_tmp.overall_box_price = products.overall_box_price ;
update_products_tmp.per_price = products.per_price ;
update_products_tmp.per_discount_price = products.per_discount_price ;
update_products_tmp.product_url = products.product_url ;
update_products_tmp.product_url_hash = row23.product_url_hash ;
...
insert_products_tmp.title = products.title ;
insert_products_tmp.category_id = products.category_id ;
insert_products_tmp.overall_pack_price = products.overall_pack_price ;
insert_products_tmp.overall_box_price = products.overall_box_price ;
insert_products_tmp.per_price = products.per_price ;
insert_products_tmp.per_discount_price = products.per_discount_price ;
insert_products_tmp.product_url = products.product_url ;
insert_products_tmp.product_url_hash = products.product_url_hash ;
...
pstmt_tDBOutput_13.setNull(1, java.sql.Types.VARCHAR);
                    ...
                    if(insert_products.title == null) {
pstmt_tDBOutput_13.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(2, insert_products.title);
}
...
pstmt_tDBOutput_13.setNull(3, java.sql.Types.INTEGER);
                    ...
                    if(insert_products.overall_pack_price == null) {
pstmt_tDBOutput_13.setNull(4, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_13.setFloat(4, insert_products.overall_pack_price);
}

                    if(insert_products.overall_box_price == null) {
pstmt_tDBOutput_13.setNull(5, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_13.setFloat(5, insert_products.overall_box_price);
}

                    if(insert_products.per_price == null) {
pstmt_tDBOutput_13.setNull(6, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_13.setFloat(6, insert_products.per_price);
}

                    if(insert_products.per_discount_price == null) {
pstmt_tDBOutput_13.setNull(7, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_13.setFloat(7, insert_products.per_discount_price);
}

                    if(insert_products.product_url == null) {
pstmt_tDBOutput_13.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(8, insert_products.product_url);
}

                    if(insert_products.product_url_hash == null) {
pstmt_tDBOutput_13.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(9, insert_products.product_url_hash);
}
...
} else {pstmt_tDBOutput_15.setString(1, update_products.source_code);
}

                    if(update_products.title == null) {
pstmt_tDBOutput_15.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_15.setString(2, update_products.title);
}

                    if(update_products.category_id == null) {
pstmt_tDBOutput_15.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_15.setInt(3, update_products.category_id);
}

                    if(update_products.overall_pack_price == null) {
pstmt_tDBOutput_15.setNull(4, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_15.setFloat(4, update_products.overall_pack_price);
}

                    if(update_products.overall_box_price == null) {
pstmt_tDBOutput_15.setNull(5, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_15.setFloat(5, update_products.overall_box_price);
}

                    if(update_products.per_price == null) {
pstmt_tDBOutput_15.setNull(6, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_15.setFloat(6, update_products.per_price);
}

                    if(update_products.per_discount_price == null) {
pstmt_tDBOutput_15.setNull(7, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_15.setFloat(7, update_products.per_discount_price);
}

                    if(update_products.product_url == null) {
pstmt_tDBOutput_15.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_15.setString(8, update_products.product_url);
}
...
pstmt_tDBOutput_15.setNull(9, java.sql.Types.TIMESTAMP);
                    ...
                    if(update_products.product_url_hash == null) {
pstmt_tDBOutput_15.setNull(10 + count_tDBOutput_15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_15.setString(10 + count_tDBOutput_15, update_products.product_url_hash);
}
...
public static class copyOfinsert_products_0Struct implements routines.system.IPersistableRow<copyOfinsert_products_0Struct> {
    final static byte[] commonByteArrayLock_BESTPACK_bestpack_job = new byte[0];
    static byte[] commonByteArray_BESTPACK_bestpack_job = new byte[0];
					...
					// Long
						...
						if(this.supplier_id == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeLong(this.supplier_id);
		            	}
     ...
     * Compare keys
     */
    public int compareTo(copyOfinsert_products_0Struct other) {
...
public static class copyOfproducts_0Struct implements routines.system.IPersistableRow<copyOfproducts_0Struct> {
    final static byte[] commonByteArrayLock_BESTPACK_bestpack_job = new byte[0];
    static byte[] commonByteArray_BESTPACK_bestpack_job = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(copyOfproducts_0Struct other) {
...
copyOfproducts_0Struct copyOfproducts_0 = new copyOfproducts_0Struct();
copyOfinsert_products_0Struct copyOfinsert_products_0 = new copyOfinsert_products_0Struct();
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfinsert_products_0");
					}
...
if(dbschema_tDBOutput_6 == null || dbschema_tDBOutput_6.trim().length() == 0) {
	tableName_tDBOutput_6 = ("bestpack_products_suppliers");
} else {
	tableName_tDBOutput_6 = dbschema_tDBOutput_6 + "\".\"" + ("bestpack_products_suppliers");
}
...
int count_tDBOutput_6=0;
	    String insert_tDBOutput_6 = "INSERT INTO \"" + tableName_tDBOutput_6 + "\" (\"product_id\",\"supplier_id\") VALUES (?,?)";
 ...
 */
	...
	currentComponent="tMap_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfproducts_0");
					}
...
// ###############################
// # Outputs initialization
copyOfinsert_products_0Struct copyOfinsert_products_0_tmp = new copyOfinsert_products_0Struct();
// ###############################
...
// ###############################
// # Outputs initialization
copyOfproducts_0Struct copyOfproducts_0_tmp = new copyOfproducts_0Struct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_9";
		...
		int tos_count_tDBInput_9 = 0;
		    ...
		    String dbquery_tDBInput_9 = "select\n	id,\n	now() as relevance\nfrom "+context.schema_out+".bestpack_products;";
            ...
            row8.id = rs_tDBInput_9.getLong(1);
			...
			row8.relevance = routines.system.JDBCUtil.getDate(rs_tDBInput_9, 2);
		                    }
...
copyOfproducts_0 = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'copyOfproducts_0'
copyOfproducts_0_tmp.product_id = row8.id ;
copyOfproducts_0_tmp.supplier_id = row9.id ;
copyOfproducts_0_tmp.relevance = row8.relevance ;
copyOfproducts_0 = copyOfproducts_0_tmp;
}  // closing inner join bracket (2)
// ###############################
 ...
 */
// Start of branch "copyOfproducts_0"
if(copyOfproducts_0 != null) { 
 					    ...
 					    boolean forceLooprow10 = false;
 							...
 							row10Struct row10ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_6 = false;
                        		    		    ...
                        		    		    row10HashKey.product_id = copyOfproducts_0.product_id ;
								  ...
								  if(!tHash_Lookup_row10.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row10 != null && tHash_Lookup_row10.getCount(row10HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row10' and it contains more one result from keys :  row10.product_id = '" + row10HashKey.product_id + "'");
								} // G 071
...
copyOfinsert_products_0 = null;

if(!rejectedInnerJoin_tMap_6 ) {
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'copyOfinsert_products_0'
// # Filter conditions 
if( rejectedInnerJoin_tMap_6 ) {
copyOfinsert_products_0_tmp.product_id = copyOfproducts_0.product_id ;
copyOfinsert_products_0_tmp.supplier_id = copyOfproducts_0.supplier_id ;
copyOfinsert_products_0 = copyOfinsert_products_0_tmp;
} // closing filter/reject
// ###############################
 ...
 */
// Start of branch "copyOfinsert_products_0"
if(copyOfinsert_products_0 != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(copyOfinsert_products_0.product_id == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_6.setLong(1, copyOfinsert_products_0.product_id);
}

                    if(copyOfinsert_products_0.supplier_id == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_6.setLong(2, copyOfinsert_products_0.supplier_id);
}
...
} // End of branch "copyOfinsert_products_0"
...
} // End of branch "copyOfproducts_0"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfproducts_0");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfinsert_products_0");
			  	}
...
public static class copyOfcopyOfsubjectsStruct implements routines.system.IPersistableRow<copyOfcopyOfsubjectsStruct> {
    final static byte[] commonByteArrayLock_BESTPACK_bestpack_job = new byte[0];
    static byte[] commonByteArray_BESTPACK_bestpack_job = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final copyOfcopyOfsubjectsStruct other = (copyOfcopyOfsubjectsStruct) obj;
	...
	public void copyDataTo(copyOfcopyOfsubjectsStruct other) {
	...
	public void copyKeysDataTo(copyOfcopyOfsubjectsStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(copyOfcopyOfsubjectsStruct other) {
...
copyOfcopyOfsubjectsStruct copyOfcopyOfsubjects = new copyOfcopyOfsubjectsStruct();
	...
	currentComponent="tDBOutput_4";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfcopyOfsubjects");
					}
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("bestpack_products");
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("bestpack_products");
}
...
int count_tDBOutput_4=0;
	    String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"prod_id\" = ? WHERE \"product_url_hash\" = ?";
...
// ###############################
// # Outputs initialization
copyOfcopyOfsubjectsStruct copyOfcopyOfsubjects_tmp = new copyOfcopyOfsubjectsStruct();
// ###############################
		    ...
		    while (rs_tDBInput_7.next()) {
		        nb_line_tDBInput_7++;
							...
							if(colQtyInRs_tDBInput_7 < 1) {
								row6.product_url_hash = null;
							} else {
	                         		
        	row6.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_7, 1, false);
		                    }
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		    ...
                        		    		    row7HashKey.product_url_hash = row6.product_url_hash ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.product_url_hash = '" + row7HashKey.product_url_hash + "'");
								} // G 071
...
copyOfcopyOfsubjects = null;

if(!rejectedInnerJoin_tMap_4 ) {

// # Output table : 'copyOfcopyOfsubjects'
copyOfcopyOfsubjects_tmp.product_url_hash = row6.product_url_hash ;
copyOfcopyOfsubjects_tmp.prod_id = row7.id ;
copyOfcopyOfsubjects = copyOfcopyOfsubjects_tmp;
}  // closing inner join bracket (2)
// ###############################
 ...
 */
// Start of branch "copyOfcopyOfsubjects"
if(copyOfcopyOfsubjects != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    if(copyOfcopyOfsubjects.prod_id == null) {
pstmt_tDBOutput_4.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(1, copyOfcopyOfsubjects.prod_id);
}

                    if(copyOfcopyOfsubjects.product_url_hash == null) {
pstmt_tDBOutput_4.setNull(2 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2 + count_tDBOutput_4, copyOfcopyOfsubjects.product_url_hash);
}
...
} // End of branch "copyOfcopyOfsubjects"
...
globalMap.put("tDBOutput_4_ERROR_MESSAGE",e_tDBOutput_4.getMessage());
	...
	nb_line_rejected_tDBOutput_4=nb_line_rejected_tDBOutput_4 + rejectedCount_tDBOutput_4;
        ...
        globalMap.put("tDBOutput_4_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_4);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfcopyOfsubjects");
			  	}
...
if(dbschema_tDBOutput_17 == null || dbschema_tDBOutput_17.trim().length() == 0) {
	tableName_tDBOutput_17 = ("bestpack_product_characteristics");
} else {
	tableName_tDBOutput_17 = dbschema_tDBOutput_17 + "\".\"" + ("bestpack_product_characteristics");
}
...
if(dbschema_tDBOutput_18 == null || dbschema_tDBOutput_18.trim().length() == 0) {
	tableName_tDBOutput_18 = ("bestpack_product_characteristics");
} else {
	tableName_tDBOutput_18 = dbschema_tDBOutput_18 + "\".\"" + ("bestpack_product_characteristics");
}
		    ...
		    while (rs_tDBInput_27.next()) {
		        nb_line_tDBInput_27++;
							...
							if(colQtyInRs_tDBInput_27 < 1) {
								row27.product_url_hash = null;
							} else {
	                         		
        	row27.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_27, 1, false);
		                    }
 					    ...
 					    boolean forceLooprow42 = false;
 							...
 							row42Struct row42ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_16 = false;
                        		    		    ...
                        		    		    row42HashKey.product_url_hash = row27.product_url_hash ;
								  ...
								  if(!tHash_Lookup_row42.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row42 != null && tHash_Lookup_row42.getCount(row42HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row42' and it contains more one result from keys :  row42.product_url_hash = '" + row42HashKey.product_url_hash + "'");
								} // G 071
...
copyOfproducts_tmp.product_id = row42.prod_id ;
...
if(dbschema_tDBOutput_19 == null || dbschema_tDBOutput_19.trim().length() == 0) {
	tableName_tDBOutput_19 = ("bestpack_images");
} else {
	tableName_tDBOutput_19 = dbschema_tDBOutput_19 + "\".\"" + ("bestpack_images");
}
...
if(dbschema_tDBOutput_20 == null || dbschema_tDBOutput_20.trim().length() == 0) {
	tableName_tDBOutput_20 = ("bestpack_images");
} else {
	tableName_tDBOutput_20 = dbschema_tDBOutput_20 + "\".\"" + ("bestpack_images");
}
 ...
 */
	...
	currentComponent="tDBInput_30";
		...
		int tos_count_tDBInput_30 = 0;
		    ...
		    String dbquery_tDBInput_30 = "select distinct on (image_url)\n	product_url_hash, \n	path,\n	image_url,\n	now() as relevance\nfrom "+context.schema_in+".bestpack_pictures\nWHERE product_url_hash IS NOT null;";
		    ...
		    while (rs_tDBInput_30.next()) {
		        nb_line_tDBInput_30++;
							...
							if(colQtyInRs_tDBInput_30 < 1) {
								row30.product_url_hash = null;
							} else {
	                         		
        	row30.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_30, 1, false);
		                    }
 					    ...
 					    boolean forceLooprow31 = false;
 							...
 							row31Struct row31ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_18 = false;
                        		    		    ...
                        		    		    row31HashKey.product_url_hash = row30.product_url_hash ;
								  ...
								  if(!tHash_Lookup_row31.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row31 != null && tHash_Lookup_row31.getCount(row31HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row31' and it contains more one result from keys :  row31.product_url_hash = '" + row31HashKey.product_url_hash + "'");
								} // G 071
...
// # Output table : 'images'
images_tmp.product_id = row31.prod_id;
...
update_images_tmp.product_id = row32.product_id ;
 ...
 */
	...
	currentComponent="tDBInput_33";
		...
		int tos_count_tDBInput_33 = 0;
		    ...
		    String dbquery_tDBInput_33 = "select 'bestpack' as name, false as parsed, now() as last_migrated";
...
query_tDBRow_1 = "\nTRUNCATE TABLE  "+context.schema_in+".bestpack_products CASCADE;\nTRUNCATE TABLE  "+context.schema_in+".bestpack_pictures CASCADE;\nTRUNCATE TABLE  "+context.schema_in+".bestpack_characteristics CASCADE;\nTRUNCATE TABLE  "+context.schema_in+".bestpack_categories CASCADE;\n";
 ...
 */
	...
	currentComponent="tDBInput_29";
		...
		int tos_count_tDBInput_29 = 0;
		    ...
		    String dbquery_tDBInput_29 = "select\n	product_id,\n	characteristic_id\nfrom "+context.schema_out+".bestpack_product_characteristics;";
			...
			int length = 0;
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.prod_id = objectIn.readLong();
           				}
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						if(this.prod_id == null) {
							...
							objectOut.writeByte(0);
							objectOut.writeLong(this.prod_id);
		            	}
		    ...
		    while (rs_tDBInput_43.next()) {
		        nb_line_tDBInput_43++;
							...
							if(colQtyInRs_tDBInput_43 < 1) {
								row42.product_url_hash = null;
							} else {
	                         		
        	row42.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_43, 1, false);
		                    }
							if(colQtyInRs_tDBInput_43 < 2) {
								row42.prod_id = null;
							} else {
		                          
            row42.prod_id = rs_tDBInput_43.getLong(2);
 ...
 */
	...
	currentComponent="tAdvancedHash_row42";
				...
				row42_HashRow.product_url_hash = row42.product_url_hash;
				
				row42_HashRow.prod_id = row42.prod_id;
		    ...
		    while (rs_tDBInput_31.next()) {
		        nb_line_tDBInput_31++;
							...
							if(colQtyInRs_tDBInput_31 < 1) {
								row31.product_url_hash = null;
							} else {
	                         		
        	row31.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_31, 1, false);
		                    }
							if(colQtyInRs_tDBInput_31 < 2) {
								row31.prod_id = null;
							} else {
		                          
            row31.prod_id = rs_tDBInput_31.getLong(2);
 ...
 */
	...
	currentComponent="tAdvancedHash_row31";
				...
				row31_HashRow.product_url_hash = row31.product_url_hash;
				
				row31_HashRow.prod_id = row31.prod_id;
 ...
 */
	...
	currentComponent="tDBInput_32";
		...
		int tos_count_tDBInput_32 = 0;
		    ...
		    String dbquery_tDBInput_32 = "select \n	product_id,\n	file_path,\n	image_url\nfrom "+context.schema_out+".bestpack_images;";
...
public static class row23Struct implements routines.system.IPersistableComparableLookupRow<row23Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.source_code = readString(dis,ois);
					
						this.title = readString(dis,ois);
					
						this.category_id = readInteger(dis,ois);
						...
						this.product_url = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.source_code = readString(dis,objectIn);
					
						this.title = readString(dis,objectIn);
					
						this.category_id = readInteger(dis,objectIn);
					
			            length = objectIn.readByte();
           				if (length == -1) {
           	    			this.overall_pack_price = null;
           				} else {
           			    	this.overall_pack_price = objectIn.readFloat();
           				}
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.overall_box_price = objectIn.readFloat();
           				}
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.per_price = objectIn.readFloat();
           				}
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.per_discount_price = objectIn.readFloat();
           				}
					
						this.product_url = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.source_code, dos, oos);
					
						writeString(this.title, dos, oos);
					
					writeInteger(this.category_id, dos, oos);
						...
						writeString(this.product_url, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.source_code, dos, objectOut);
					
						writeString(this.title, dos, objectOut);
					
					writeInteger(this.category_id, dos, objectOut);
					
						if(this.overall_pack_price == null) {
							objectOut.writeByte(-1);
						} else {
							objectOut.writeByte(0);
							objectOut.writeFloat(this.overall_pack_price);
		            	}
						...
						if(this.overall_box_price == null) {
							...
							objectOut.writeByte(0);
							objectOut.writeFloat(this.overall_box_price);
		            	}
						...
						if(this.per_price == null) {
							...
							objectOut.writeByte(0);
							objectOut.writeFloat(this.per_price);
		            	}
						...
						if(this.per_discount_price == null) {
							...
							objectOut.writeByte(0);
							objectOut.writeFloat(this.per_discount_price);
		            	}
					
						writeString(this.product_url, dos, objectOut);
...
+"rice,\n	product_url,\n	product_url_hash\nfrom "+context.schema_out+".bestpack_products;";
        	...
        	row23.title = routines.system.JDBCUtil.getString(rs_tDBInput_23, 2, false);
		                    }
							if(colQtyInRs_tDBInput_23 < 3) {
								row23.category_id = null;
							} else {
		                          
            row23.category_id = rs_tDBInput_23.getInt(3);
            if(rs_tDBInput_23.wasNull()){
                    row23.category_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_23 < 4) {
								row23.overall_pack_price = null;
							} else {
		                          
            row23.overall_pack_price = rs_tDBInput_23.getFloat(4);
            if(rs_tDBInput_23.wasNull()){
                    row23.overall_pack_price = null;
            }
		                    }
							if(colQtyInRs_tDBInput_23 < 5) {
								row23.overall_box_price = null;
							} else {
		                          
            row23.overall_box_price = rs_tDBInput_23.getFloat(5);
            if(rs_tDBInput_23.wasNull()){
                    row23.overall_box_price = null;
            }
		                    }
							if(colQtyInRs_tDBInput_23 < 6) {
								row23.per_price = null;
							} else {
		                          
            row23.per_price = rs_tDBInput_23.getFloat(6);
            if(rs_tDBInput_23.wasNull()){
                    row23.per_price = null;
            }
		                    }
							if(colQtyInRs_tDBInput_23 < 7) {
								row23.per_discount_price = null;
							} else {
		                          
            row23.per_discount_price = rs_tDBInput_23.getFloat(7);
            if(rs_tDBInput_23.wasNull()){
                    row23.per_discount_price = null;
            }
		                    }
							if(colQtyInRs_tDBInput_23 < 8) {
								row23.product_url = null;
							} else {
	                         		
        	row23.product_url = routines.system.JDBCUtil.getString(rs_tDBInput_23, 8, false);
		                    }
							if(colQtyInRs_tDBInput_23 < 9) {
								row23.product_url_hash = null;
							} else {
	                         		
        	row23.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_23, 9, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row23";
				...
				row23_HashRow.category_id = row23.category_id;
				
				row23_HashRow.overall_pack_price = row23.overall_pack_price;
				
				row23_HashRow.overall_box_price = row23.overall_box_price;
				
				row23_HashRow.per_price = row23.per_price;
				
				row23_HashRow.per_discount_price = row23.per_discount_price;
				
				row23_HashRow.product_url = row23.product_url;
				
				row23_HashRow.product_url_hash = row23.product_url_hash;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// source node:tDBInput_8 - inputs:(after_tDBInput_7) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
			   		// linked node: tMap_4 - inputs:(row6,row7) outputs:(copyOfcopyOfsubjects)
		    ...
		    while (rs_tDBInput_8.next()) {
		        nb_line_tDBInput_8++;
							...
							if(colQtyInRs_tDBInput_8 < 1) {
								row7.product_url_hash = null;
							} else {
	                         		
        	row7.product_url_hash = routines.system.JDBCUtil.getString(rs_tDBInput_8, 1, false);
		                    }
							if(colQtyInRs_tDBInput_8 < 2) {
								row7.id = null;
							} else {
		                          
            row7.id = rs_tDBInput_8.getInt(2);
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.product_url_hash = row7.product_url_hash;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row9";
		...
		int tos_count_tAdvancedHash_row9 = 0;
			   		...
			   		// source node:tDBInput_10 - inputs:(after_tDBInput_9) outputs:(row9,row9) | target node:tAdvancedHash_row9 - inputs:(row9) outputs:()
			   		// linked node: tMap_5 - inputs:(row8,row9) outputs:(copyOfproducts_0)
 ...
 */
	...
	currentComponent="tDBInput_10";
		...
		int tos_count_tDBInput_10 = 0;
		    ...
		    String dbquery_tDBInput_10 = "select\n	id\nfrom "+context.schema_out+".bestpack_suppliers;";
            ...
            row9.id = rs_tDBInput_10.getLong(1);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row10";
		...
		int tos_count_tAdvancedHash_row10 = 0;
			   		...
			   		// source node:tDBInput_11 - inputs:(after_tDBInput_9) outputs:(row10,row10) | target node:tAdvancedHash_row10 - inputs:(row10) outputs:()
			   		// linked node: tMap_6 - inputs:(copyOfproducts_0,row10) outputs:(copyOfinsert_products_0)
 ...
 */
	...
	currentComponent="tDBInput_11";
		...
		int tos_count_tDBInput_11 = 0;
		    ...
		    String dbquery_tDBInput_11 = "select\n	product_id\nfrom "+context.schema_out+".bestpack_products_suppliers;";
		    ...
		    while (rs_tDBInput_11.next()) {
		        nb_line_tDBInput_11++;
							...
							if(colQtyInRs_tDBInput_11 < 1) {
								row10.product_id = null;
							} else {
		                          
            row10.product_id = rs_tDBInput_11.getLong(1);
 ...
 */
	...
	currentComponent="tAdvancedHash_row10";
				...
				row10_HashRow.product_id = row10.product_id;
 ...
 */
    ...
    public static void main(String[] args){
        final bestpack_job bestpack_jobClass = new bestpack_job();

        int exitCode = bestpack_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = bestpack_job.class.getClassLoader().getResourceAsStream("bestpack/bestpack_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = bestpack_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : bestpack_job");
        }
...
/************************************************************************************************
 *     852103 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 июля 2025 г., 14:43:40 QYZT
 ************************************************************************************************/